...
Public Class TrxForm
    ...
    Private Sub SetSharedControls(ByVal objTrx As BaseTrx)
        Try
            ...
            With objTrx
                ...
                SetComboFromStringTranslator(cboRepeatKey, mobjAccount.Repeats, .strRepeatKey)
    ...
    Private Sub SetTransferControls(ByVal objTrx As TransferTrx)
        With objTrx
            chkFake.CheckState = CType(IIf(.blnFake, System.Windows.Forms.CheckState.Checked, System.Windows.Forms.CheckState.Unchecked), CheckState)
            SetComboFromStringTranslator(cboTransferTo, mobjAccount.RegisterList(), .strTransferKey)
