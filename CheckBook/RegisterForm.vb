...
Friend Class RegisterForm
    ...
    Private Sub cmdDelete_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            With objTrx
                If .lngType = Trx.TrxType.glngTRXTYP_REPLICA Then
    ...
    Private Sub EditTrx()
        ...
        If lngIndex < 0 Then
            ...
            Exit Sub
        End If
        If mobjReg.objTrx(lngIndex).lngType = Trx.TrxType.glngTRXTYP_REPLICA Then
    ...
    Private Sub ConfigGrid()
        ...
        ConfigGridCol(intCol, mintColPONumber, "PO#", 900,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.glngTRXTYP_NORMAL, DirectCast(objTrx, NormalTrx).strSummarizePONumber(), ""))
        ConfigGridCol(intCol, mintColInvoiceNum, "Invoice#", 900,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.glngTRXTYP_NORMAL, DirectCast(objTrx, NormalTrx).strSummarizeInvoiceNum(), ""))
        ConfigGridCol(intCol, mintColInvoiceDate, "Inv. Date", 700,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.glngTRXTYP_NORMAL, DirectCast(objTrx, NormalTrx).strSummarizeInvoiceDate(), ""))
        ConfigGridCol(intCol, mintColDueDate, "Due Date", 700,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.glngTRXTYP_NORMAL, DirectCast(objTrx, NormalTrx).strSummarizeDueDate(), ""))
        ConfigGridCol(intCol, mintColTerms, "Terms", 800,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.glngTRXTYP_NORMAL, DirectCast(objTrx, NormalTrx).strSummarizeTerms(), ""))
