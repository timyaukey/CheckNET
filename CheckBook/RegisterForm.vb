...
Friend Class RegisterForm
    ...
    Private mintColMemo As Integer
    ...
    Private mintColMatchRange As Integer
    Private mintColAwaitingReview As Integer
    Private mintColAutoGenerated As Integer
    Private mintColRepeatSeq As Integer
    Private mintColImportKey As Integer
    Private mintColRepeatKey As Integer
    Private mintColBudgetKey As Integer
    Private mintColBudgetUnmatched As Integer
    Private mintColTransferKey As Integer
    ...
    Private Sub ConfigGrid()
        ...
        ConfigGridCol(intCol, mintColAwaitingReview, "Guessed", 800,
