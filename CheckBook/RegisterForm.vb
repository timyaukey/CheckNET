...
Friend Class RegisterForm
    ...
    Private Sub cmdDelete_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdDelete.Click
        ...
        Try
            ...
            With objTrx
                If .lngType = Trx.TrxType.Replica Then
                    MsgBox("You may not delete a replica transaction. Instead delete the split it was created from in another transaction.", MsgBoxStyle.Critical)
                    Exit Sub
                End If
    ...
    Private Sub ConfigGrid()
        ...
        ConfigGridCol(intCol, mintColPONumber, "PO#", 900,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.Normal, DirectCast(objTrx, NormalTrx).strSummarizePONumber(), ""))
        ConfigGridCol(intCol, mintColInvoiceNum, "Invoice#", 900,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.Normal, DirectCast(objTrx, NormalTrx).strSummarizeInvoiceNum(), ""))
        ConfigGridCol(intCol, mintColInvoiceDate, "Inv. Date", 700,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.Normal, DirectCast(objTrx, NormalTrx).strSummarizeInvoiceDate(), ""))
        ConfigGridCol(intCol, mintColDueDate, "Due Date", 700,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.Normal, DirectCast(objTrx, NormalTrx).strSummarizeDueDate(), ""))
        ConfigGridCol(intCol, mintColTerms, "Terms", 800,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.Normal, DirectCast(objTrx, NormalTrx).strSummarizeTerms(), ""))
        ConfigGridCol(intCol, mintColFake, "Fake", 500, _
            Function(objTrx As Trx) If(objTrx.lngType <> Trx.TrxType.Budget, If(objTrx.blnFake, "Y", ""), "-"))
        ...
        ConfigGridCol(intCol, mintColImportKey, "Imported", 800,
            Function(objTrx As Trx) If(objTrx.lngType = Trx.TrxType.Normal,
    ...
    Private Sub grdReg_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles grdReg.CellFormatting
        ...
        If Not mobjReg Is Nothing Then
            If e.RowIndex < mobjReg.lngTrxCount Then
                ...
                ElseIf objTrx.lngType = Trx.TrxType.Budget Then
