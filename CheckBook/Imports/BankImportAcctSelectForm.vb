    ...
    Public Sub ShowMe(ByVal strTitle As String, ByVal objImportHandler As IImportHandler, ByVal objTrxReader As ITrxReader, ByVal lngUpdateSearchType As CBMain.ImportBatchUpdateSearch, ByVal lngNewSearchType As CBMain.ImportBatchNewSearch, ByVal lngIndividualUpdateType As CBMain.ImportIndividualUpdateType, ByVal lngIndividualSearchType As CBMain.ImportIndividualSearchType, ByVal lngBatchUpdateType As CBMain.ImportBatchUpdateType, ByVal blnFake As Boolean)
        ...
        Try
            ...
            If Not mobjAccount Is Nothing Then
                ...
                frm.ShowMe(strTitle, mobjAccount, objImportHandler, objTrxReader, lngUpdateSearchType, lngNewSearchType, lngIndividualUpdateType, lngIndividualSearchType, lngBatchUpdateType, blnFake)
            End If
            Exit Sub
