...
Partial Class TrialBalanceForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.lblBalanceSheetAccounts.TabIndex = 4
        ...
        Me.lblResultSummary.TabIndex = 8
