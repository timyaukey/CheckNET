...
Public Class RegisterLoader
    ...
    Public Sub LoadFile(ByVal objReg As Register, ByVal objRepeatSummarizer As RepeatSummarizer, _
        ...
        Exit Sub
ErrorHandler:
        gNestedErrorTrap("RegisterLoader.LoadFile")
    End Sub
    ...
    Private Sub CreateOneTrx(ByVal objTargetReg As Register, ByVal blnFake As Boolean)
        ...
        Select Case mlngType
            Case Trx.TrxType.glngTRXTYP_NORMAL
                ...
                End If
                objTrx.NewStartNormal(objTargetReg, mstrNumber, mdatDate, mstrDescription, mstrMemo, mlngStatus, blnFake, mcurNormalMatchRange, mblnAwaitingReview, blnAutoGenerated, mintRepeatSeq, mstrImportKey, mstrRepeatKey)
        ...
        Exit Sub
ErrorHandler:
        gNestedErrorTrap("RegisterLoader.CreateOneTrx")
    End Sub
End Class