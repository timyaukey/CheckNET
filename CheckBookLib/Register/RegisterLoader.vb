        ...
        Try
            ...
            Select Case mlngType
                Case Trx.TrxType.glngTRXTYP_NORMAL
                    ...
                    End If
                    objNormalTrx.NewStartNormal(objTargetReg, mstrNumber, mdatDate, mstrDescription, mstrMemo, mlngStatus, blnFake,
                    ...
                    If objTargetReg.blnRepeat Then
                        objNormalTrx.SetSharedRptProps(mlngRptUnit, mintRptNumber, mdatRptEnd)
                    End If
                ...
                Case Trx.TrxType.glngTRXTYP_BUDGET
                    ...
                    objBudgetTrx.NewStartBudget(objTargetReg, mdatDate, mstrDescription, mstrMemo, mblnAwaitingReview, blnAutoGenerated, mintRepeatSeq, mstrRepeatKey, mcurAmount, mdatBudgetEnds, mstrBudgetKey)
                    If objTargetReg.blnRepeat Then
                        objBudgetTrx.SetSharedRptProps(mlngRptUnit, mintRptNumber, mdatRptEnd)
                        objBudgetTrx.SetBudgetRptProps(mlngBudgetUnit, mintBudgetNumber)
                    End If
                ...
                Case Trx.TrxType.glngTRXTYP_TRANSFER
                    ...
                    End If
                    Dim objXfrTrx As TransferTrx = New TransferTrx()
                    objXfrTrx.NewStartTransfer(objTargetReg, mdatDate, mstrDescription, mstrMemo, blnFake, mblnAwaitingReview, blnAutoGenerated, mintRepeatSeq, mstrRepeatKey, mstrTransferKey, mcurAmount)
                    If objTargetReg.blnRepeat Then
                        objXfrTrx.SetSharedRptProps(mlngRptUnit, mintRptNumber, mdatRptEnd)
                    End If
