...
Module TrxGenerator
	...
	Public Sub gCreateGeneratedTrx(ByVal objAccount As Account, ByVal objReg As Register, ByVal datRptEndMax As Date)
		...
		Dim datTrxToCreate As ITrxGenerator.TrxToCreate
	...
	Public Function gstrCreateOneTrx(ByRef c As ITrxGenerator.TrxToCreate, ByVal objTargetReg As Register, ByVal colRegisters As Collection) As String
		...
		Select Case c.lngType
			...
			Case Trx.TrxType.glngTRXTYP_BUDGET
				...
				End If
				If c.datBudgetEnds = System.Date.FromOADate(0) Then
	...
	Public Function gcolTrxToCreateFromSeqTrx(ByRef datSeqTrx() As SequencedTrx, ByRef datTrxTemplate As ITrxGenerator.TrxToCreate) As Collection
		...
		Dim datTrxTmp As ITrxGenerator.TrxToCreate
