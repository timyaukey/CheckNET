...
Public Class BankTrx
    ...
    Public Overrides Function objClone(ByVal blnWillAddToRegister As Boolean) As BaseTrx
        Dim objNormalTrx As BankTrx = New BankTrx(mobjReg)
    ...
    Public Overrides Sub Validate()
        ...
        Else
            ...
            For Each objSplit In mcolSplits
                ...
                If Not objSplit.objBudget Is Nothing Then
                    If objSplit.objBudget.GetType() IsNot GetType(BudgetTrx) Then
                        objReg.FireValidationError(Me, "Split applied to non-budget trx")
                    End If
                    If objSplit.strBudgetKey = "" Then
                        objReg.FireValidationError(Me, "Split applied to budget trx has no budget key")
                    End If
                ...
                If blnAccountIsPersonal <> CategoryTranslator.blnIsPersonal(objCategories.strKeyToValue1(objSplit.strCategoryKey)) Then
                    objReg.FireValidationError(Me, "Split category mixes personal and business")
                End If
            ...
            If curTotal <> mcurAmount Then
                objReg.FireValidationError(Me, "Normal trx splits add up wrong")
            End If
        End If
        If mblnFake Then
            If mstrImportKey <> "" Then
                objReg.FireValidationError(Me, "Normal trx cannot have import key if it is fake")
            End If
            If mlngStatus <> TrxStatus.Unreconciled Then
                objReg.FireValidationError(Me, "Normal trx must be unreconciled if it is fake")
            End If
        End If
    End Sub
