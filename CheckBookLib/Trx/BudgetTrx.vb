...
Public Class BudgetTrx
    ...
    Public Sub NewStartBudget(ByVal objReg As Register, ByVal datDate_ As Date, ByVal strDescription_ As String,
    ...
    Public Overrides Function objClone(objReg As Register) As Trx
        ...
        objBudgetTrx.NewStartBudget(objReg, mdatDate, mstrDescription, mstrMemo, mblnAwaitingReview, mblnAutoGenerated,
