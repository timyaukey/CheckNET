...
Public Class Trx
    ...
    Public Sub NewStartNormal(ByVal objReg As Register, ByVal strNumber_ As String, ByVal datDate_ As Date,
                              ...
                              ByVal intRepeatSeq_ As Short, ByVal strImportKey_ As String,
    ...
    Public Sub UpdateStartNormal(ByVal strNumber_ As String, ByVal datDate_ As Date, ByVal strDescription_ As String,
                                 ...
                                 ByVal blnAutoGenerated_ As Boolean, ByVal intRepeatSeq_ As Short,
    ...
    Public Sub UpdateStartBudget(ByVal datDate_ As Date, ByVal strDescription_ As String, ByVal strMemo_ As String,
                                 ByVal blnAwaitingReview_ As Boolean, ByVal blnAutoGenerated_ As Boolean,
                                 ByVal intRepeatSeq_ As Short, ByVal strRepeatKey_ As String, ByVal curBudgetLimit_ As Decimal,
    ...
    Public Sub UpdateStartTransfer(ByVal datDate_ As Date, ByVal strDescription_ As String, ByVal strMemo_ As String, ByVal blnFake_ As Boolean, ByVal blnAwaitingReview_ As Boolean, ByVal blnAutoGenerated_ As Boolean, ByVal intRepeatSeq_ As Short, ByVal strRepeatKey_ As String, ByVal curTransferAmount_ As Decimal)
    ...
    Private Sub ImportUpdateShared()
        mblnAutoGenerated = False
        mblnFake = False
    End Sub
    ...
    Public Sub SetSortKey()
        ...
        Else
            strDebitCredit = "D"
        End If
        mstrSortKey = mdatDate.ToString("yyyyMMdd") & strDebitCredit & Mid("ZYX", mlngType + 1, 1) &
    ...
    Public Sub Validate(ByVal objReg As Register, ByVal lngIndex As Integer)
        ...
        If mstrSortKey = "" Then
            objReg.RaiseValidationError(lngIndex, "Missing sort key")
        End If
        If mdatDate = System.DateTime.FromOADate(0) Then
            objReg.RaiseValidationError(lngIndex, "Missing date")
        End If
        If mstrRepeatKey <> "" Then
            If mintRepeatSeq = 0 Then
                objReg.RaiseValidationError(lngIndex, "Repeat key has no repeat seq")
            End If
            objRepeatTrx = objReg.objRepeatTrx(mstrRepeatKey, mintRepeatSeq)
            If Not objRepeatTrx Is Me Then
                objReg.RaiseValidationError(lngIndex, "objRepeatTrx() returned wrong Trx")
            End If
        Else
            If mintRepeatSeq <> 0 Then
                objReg.RaiseValidationError(lngIndex, "Repeat seq should be zero")
            End If
        End If
        Select Case mlngType
            ...
            Case Else
                objReg.RaiseValidationError(lngIndex, "Invalid trx type")
        End Select
    End Sub
