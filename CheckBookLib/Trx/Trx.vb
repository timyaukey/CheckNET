...
Public Class Trx
    ...
    Public Sub NewStartNormal(ByVal objReg As Register, ByVal strNumber_ As String, ByVal datDate_ As Date, ByVal strDescription_ As String, ByVal strMemo_ As String, ByVal lngStatus_ As TrxStatus, ByVal blnFake_ As Boolean, ByVal curNormalMatchRange_ As Decimal, ByVal blnAwaitingReview_ As Boolean, ByVal blnAutoGenerated_ As Boolean, ByVal intRepeatSeq_ As Short, ByVal strImportKey_ As String, ByVal strRepeatKey_ As String)
    ...
    Public Sub UpdateStartNormal(ByVal objReg As Register, ByVal strNumber_ As String, ByVal datDate_ As Date, ByVal strDescription_ As String, ByVal strMemo_ As String, ByVal lngStatus_ As TrxStatus, ByVal blnFake_ As Boolean, ByVal curNormalMatchRange_ As Decimal, ByVal blnAwaitingReview_ As Boolean, ByVal blnAutoGenerated_ As Boolean, ByVal intRepeatSeq_ As Short, ByVal strImportKey_ As String, ByVal strRepeatKey_ As String)
    ...
    Public Sub ImportUpdateBank(ByVal strNumber_ As String, ByVal blnFake_ As Boolean, ByVal curAmount_ As Decimal, ByVal strImportKey_ As String)
    ...
    Public Sub SetSortKey()
        ...
        End If
        mstrSortKey = VB6.Format(mdatDate, "yyyymmdd") & IIf(mcurAmount > 0, "C", "D") & Mid("ZYX", mlngType + 1, 1) & Left(mstrNumber & "          ", 10) & Left(mstrDescription & "                    ", 20) & Left(strInvNum & "                ", 16)
    End Sub
    ...
    Public Function blnIsSearchMatch(ByVal lngSearchField As TrxSearchField, ByVal strSearchFor As String, ByVal lngSearchType As TrxSearchType, ByRef curMatchAmount As Decimal) As Boolean
        ...
        Select Case lngSearchField
            ...
            Case TrxSearchField.glngTRXSFL_AMOUNT
                strTrxData = VB6.Format(mcurAmount, gstrFORMAT_CURRENCY)
    ...
    Public Sub CopyNormal(ByVal objDstTrx As Trx, ByVal objReg As Register)
        objDstTrx.NewStartNormal(objReg, mstrNumber, mdatDate, mstrDescription, mstrMemo, mlngStatus, mblnFake, mcurNormalMatchRange, mblnAwaitingReview, mblnAutoGenerated, mintRepeatSeq, mstrImportKey, mstrRepeatKey)
    End Sub
