...
Public Class Trx
    ...
    Public Sub UpdateStartNormal(ByVal objReg As Register, ByVal strNumber_ As String, ByVal datDate_ As Date, ByVal strDescription_ As String,
    ...
    Public Sub UpdateStartNormal(ByVal objReg As Register, ByVal objTrx As Trx)
        With objTrx
            UpdateStartNormal(objReg, .strNumber, .datDate, .strDescription, .strMemo, .lngStatus, .blnFake,
