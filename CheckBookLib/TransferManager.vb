...
Public Class TransferManager
    ...
    Public Sub UpdateTransfer(ByVal objReg1 As Register, ByVal lngIndex1 As Integer, ByVal objReg2 As Register, ByVal datDate As Date, ByVal strDescription As String, ByVal strMemo As String, ByVal blnFake As Boolean, ByVal curTransferAmount As Decimal, ByVal strRepeatKey As String, ByVal blnAwaitingReview As Boolean, ByVal blnAutoGenerated As Boolean, ByVal intRepeatSeq As Short)
        ...
        Dim objTrx1 As Trx
        Dim objTrx1Old As Trx
        Dim objTrx2 As Trx
        Dim objTrx2Old As Trx

        objTrx1 = objReg1.objTrx(lngIndex1)
        objTrx1Old = objTrx1.objClone(Nothing)
        ...
        End If
        objTrx2 = objReg2.objTrx(lngIndex2)
        objTrx2Old = objTrx2.objClone(Nothing)
        objTrx1.UpdateStartTransfer(objReg1, datDate, strDescription, strMemo, blnFake, blnAwaitingReview, blnAutoGenerated, intRepeatSeq, strRepeatKey, curTransferAmount)
        objTrx2.UpdateStartTransfer(objReg2, datDate, strDescription, strMemo, blnFake, blnAwaitingReview, blnAutoGenerated, intRepeatSeq, strRepeatKey, -curTransferAmount)
        ...
        objReg1.UpdateEnd(lngIndex1, New LogChange, "UpdateTransfer1", objTrx1Old)
        'UPGRADE_WARNING: Couldn't resolve default property of object New (LogChange). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        objReg2.UpdateEnd(lngIndex2, New LogChange, "UpdateTransfer2", objTrx2Old)
